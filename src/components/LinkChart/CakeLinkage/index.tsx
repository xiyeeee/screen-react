...
const CakeLinkage = () => {
          ...
          series: [
            {
              data: [
                {
                  name: "金融类",
                  value: dataMap.dataJR["2016sum"],
                  itemStyle: itemStyleJR,
                },
                {
                  name: "政务类",
                  value: dataMap.dataZW["2016sum"],
                  itemStyle: itemStyleZW,
                },
                {
                  name: "医疗类",
                  value: dataMap.dataYL["2016sum"],
                  itemStyle: itemStyleYL,
                },
                {
                  name: "互联网类",
                  value: dataMap.dataIT["2016sum"],
          ...
          series: [
            {
              data: [
                {
                  name: "金融类",
                  value: dataMap.dataJR["2017sum"],
                  itemStyle: itemStyleJR,
                },
                {
                  name: "政务类",
                  value: dataMap.dataZW["2017sum"],
                  itemStyle: itemStyleZW,
                },
                {
                  name: "医疗类",
                  value: dataMap.dataYL["2017sum"],
                  itemStyle: itemStyleYL,
                },
                {
                  name: "互联网类",
                  value: dataMap.dataIT["2017sum"],
                  itemStyle: itemStyleIT,
                },
              ],
            },
          ...
          series: [
            {
              data: [
                {
                  name: "金融类",
                  value: dataMap.dataJR["2018sum"],
                  itemStyle: itemStyleJR,
                },
                {
                  name: "政务类",
                  value: dataMap.dataZW["2018sum"],
                  itemStyle: itemStyleZW,
                },
                {
                  name: "医疗类",
                  value: dataMap.dataYL["2018sum"],
                  itemStyle: itemStyleYL,
                },
                {
                  name: "互联网类",
                  value: dataMap.dataIT["2018sum"],
                  itemStyle: itemStyleIT,
                },
              ],
            },
          ...
          series: [
            {
              data: [
                {
                  name: "金融类",
                  value: dataMap.dataJR["2019sum"],
                  itemStyle: itemStyleJR,
                },
                {
                  name: "政务类",
                  value: dataMap.dataZW["2019sum"],
                  itemStyle: itemStyleZW,
                },
                {
                  name: "医疗类",
                  value: dataMap.dataYL["2019sum"],
                  itemStyle: itemStyleYL,
                },
                {
                  name: "互联网类",
                  value: dataMap.dataIT["2019sum"],
                  itemStyle: itemStyleIT,
                },
              ],
            },
          ...
          series: [
            {
              data: [
                {
                  name: "金融类",
                  value: dataMap.dataJR["2020sum"],
                  itemStyle: itemStyleJR,
                },
                {
                  name: "政务类",
                  value: dataMap.dataZW["2020sum"],
                  itemStyle: itemStyleZW,
                },
                {
                  name: "医疗类",
                  value: dataMap.dataYL["2020sum"],
                  itemStyle: itemStyleYL,
                },
                {
                  name: "互联网类",
                  value: dataMap.dataIT["2020sum"],
                  itemStyle: itemStyleIT,
                },
              ],
            },
  ...
  return (
    <div className={styles.cakeLinkageContainer}>
      <ChartBase
        title="柱饼组合联动"
        option={option}
        id="chart_bp"
